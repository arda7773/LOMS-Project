    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Administrator'), ('FACULTY', 'Faculty Member'), ('LECTURER', 'Lecturer'), ('STUDENT', 'Student')], max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('faculty_manager', models.ForeignKey(limit_choices_to={'role': 'FACULTY'}, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='course',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('lo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.courselearningoutcome')),
                ('po', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.programoutcome')),
            ],
        ),
        migrations.CreateModel(
            name='Syllabus',
